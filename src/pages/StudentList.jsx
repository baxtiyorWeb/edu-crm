...
const StudentList = () => {
	const { studentList, isloading, addNewStudents } = useFormStudents();
	...
	return (
		<div>
			<div className='flex justify-between my-5 border-b items-center pb-3'>
				<h1 className='text text-2xl'>ro&apos;xatdagi o&apos;quvchilar</h1>
			...
			<TableComponent
				...
				columns={columns}
				key={`key_${keysArr.length}_${keys}`}
				loading={isloading}
			/>
		</div>
	);
